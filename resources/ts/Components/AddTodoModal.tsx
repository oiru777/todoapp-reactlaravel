...
const AddTodoModal: React.FC<Props> = ({
  open, onClose, newContent, newTags, newDueDate,
  setNewContent, setNewTags, setNewDueDate,
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Box sx={{
        ...
        boxShadow: 24, width: 320, display: "flex",
        ...
        <Box sx={{ display: "flex", gap: 1, mt: 2 }}>
          <Button variant="contained" onClick={handleAddTodo} fullWidth>追加</Button>
          <Button variant="outlined" onClick={onClose} fullWidth>キャンセル</Button>
        </Box>
